  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        ...
        className="w-full bg-[#ff9900] hover:bg-[#ec8c00] text-[#111111] font-semibold text-xs py-2 px-4 rounded shadow-sm transition-all text-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:opacity-50 disabled:cursor-not-allowed"
      >
